    ...
    <section id="about" className="py-24 px-6 lg:px-8 bg-secondary/30">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl md:text-5xl tracking-wider mb-6">
              ABOUT US
            </h2>
            <p className="text-muted-foreground mb-6 leading-relaxed">
              ...
              rooted in understanding each client's unique vision and translating it into reality.
            </p>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              Every project is a collaboration, where we combine our expertise with your aspirations
              to craft environments that inspire and endure. From initial concept to final installation,
              we ensure meticulous attention to detail and exceptional quality.
            </p>

      ...
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
            ...
            <form onSubmit={handleSubmit} className='space-y-6'>
              ...
              <div>
                ...
                <textarea
                  ...
                  className='w-full px-4 py-3 bg-input-background border border-border focus:outline-none focus:ring-2 focus:ring-primary resize-none transition-all'></textarea>
              </div>
          ...
          <div className='space-y-8'>
            <div>
              <h3 className='mb-6 tracking-wide text-2xl'>CONTACT INFORMATION</h3>
            ...
            <div>
              <h3 className='mb-6 tracking-wide text-2xl'>FOLLOW US</h3>
            ...
            <div className='bg-secondary/50 p-8'>
              <h4 className='mb-4 tracking-wide text-xl'>Office Hours</h4>
            ...
            <div className='bg-primary text-primary-foreground p-8'>
              <h4 className='mb-3 tracking-wide text-xl'>Book a Consultation</h4>
